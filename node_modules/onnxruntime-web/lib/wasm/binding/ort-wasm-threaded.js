...
a.on("error",function(g){a.onerror(g)}));var d=[],f=["onExit","onAbort","print","printErr"],h;for(h of f)w.hasOwnProperty(h)&&d.push(h);a.postMessage({cmd:"load",handlers:d,urlOrBlob:w.mainScriptUrlOrBlob||_scriptDir,wasmMemory:c,wasmModule:ra})}),eb:function(a){a()},Za:function(){var a=la("ort-wasm-threaded.worker.js");a=new Worker(a);S.Na.push(a)},bb:function(){0==S.Na.length&&(S.Za(),S.fb(S.Na[0]));return S.Na.pop()}};w.PThread=S;function W(a){for(;0<a.length;)a.shift()(w)}
...
return{}})();w._OrtInit=function(){return(w._OrtInit=w.asm._).apply(null,arguments)};w._OrtGetLastError=function(){return(w._OrtGetLastError=w.asm.$).apply(null,arguments)};w._OrtCreateSessionOptions=function(){return(w._OrtCreateSessionOptions=w.asm.aa).apply(null,arguments)};w._OrtAppendExecutionProvider=function(){return(w._OrtAppendExecutionProvider=w.asm.ba).apply(null,arguments)};w._OrtAddSessionConfigEntry=function(){return(w._OrtAddSessionConfigEntry=w.asm.ca).apply(null,arguments)};
w._OrtReleaseSessionOptions=function(){return(w._OrtReleaseSessionOptions=w.asm.da).apply(null,arguments)};w._OrtCreateSession=function(){return(w._OrtCreateSession=w.asm.ea).apply(null,arguments)};w._OrtReleaseSession=function(){return(w._OrtReleaseSession=w.asm.fa).apply(null,arguments)};w._OrtGetInputOutputCount=function(){return(w._OrtGetInputOutputCount=w.asm.ga).apply(null,arguments)};w._OrtGetInputName=function(){return(w._OrtGetInputName=w.asm.ha).apply(null,arguments)};
